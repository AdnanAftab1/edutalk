...
export default function Home({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[500px] h-[500px] bg-[#3B82F6] opacity-10 rounded-full blur-[100px]" />
      <div className="absolute bottom-0 left-1/4 w-[300px] h-[300px] bg-blue-700 opacity-15 rounded-full blur-[80px]" />
...
function TeacherNavbar({ selected }: SelectedProps) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-row">
        ...
        <div className="w-full flex justify-center items-center gap-x-10">
          <Link
            ...
            className={cn("font-['Inter'] text-lg hover:text-blue-500 duration-200", selected === 'students' ? 'text-blue-500' : '')}
          >
            Students
          </Link>
          ...
          <Link
            ...
            className={cn("font-['Inter'] text-lg hover:text-blue-500 duration-200", selected === 'attendance' ? 'text-blue-500' : '')}
          >
            Attendance
          </Link>
          ...
          <Link
            ...
            className={cn("font-['Inter'] text-lg hover:text-blue-500 duration-200", selected === 'academics' ? 'text-blue-500' : '')}
          >
            Academics
          </Link>
        ...
        <button
          ...
          className="w-min p-3 font-bold text-xl font-['Inter'] bg-gradient-to-r from-blue-500 to-blue-700 bg-clip-text text-transparent cursor-pointer whitespace-nowrap"
          title="Logout"
        >
          {teacherName}
        </button>
